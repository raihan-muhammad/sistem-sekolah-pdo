...
$pdf->SetAuthor('Salsa');
$pdf->SetTitle('Laporan Pembimbing');
$pdf->SetSubject('Pembimbing');
$pdf->SetKeywords('TCPDF, PDF, Pembimbing, laporan');
...
$pdf->Write(0, 'Laporan Pembimbing', '', 0, 'C', true, 0, false, false, 0);
...
function fetch_data() {
	include 'koneksi.php';
	$output = '';
	$sql = "SELECT pm.*, pr.* FROM tb_pembimbing pm INNER JOIN tb_perusahaan pr ON pm.fk_perusahaan = pr.id_perusahaan ORDER BY pm.nama_pembimbing ASC";
...
$pdf->Output('laporan_pembimbing.pdf', 'I');
