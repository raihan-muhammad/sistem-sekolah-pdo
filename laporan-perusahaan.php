...
$pdf->SetSubject('Perusahaan');
$pdf->SetKeywords('TCPDF, PDF, Perusahaan, laporan');
...
$pdf->Write(0, 'Laporan Perusahaan', '', 0, 'C', true, 0, false, false, 0);
...
function fetch_data() {
	include 'koneksi.php';
	$output = '';
	$sql = "SELECT * FROM tb_perusahaan ORDER BY nama_perusahaan ASC";
