...
$pdf->SetAuthor('Salsa');
$pdf->SetTitle('Laporan Guru Wali');
$pdf->SetSubject('Guru Wali');
$pdf->SetKeywords('TCPDF, PDF, Guru, Wali, laporan');
...
$pdf->Write(0, 'Laporan Guru Wali', '', 0, 'C', true, 0, false, false, 0);
...
function fetch_data() {
	include 'koneksi.php';
	$output = '';
	$sql = "SELECT * FROM tb_guruwali ORDER BY nama_guruwali ASC";
	...
	while($row = $result->fetch(PDO::FETCH_ASSOC)) {   
		...
		<td align="center">'.$row['nama_guruwali'].'</td>
		<td align="center">'.$row['perwalian'].'</td>
...
<th align="center"><b>Perwalian</b></th>
...
$pdf->Output('laporan_guruwali.pdf', 'I');
